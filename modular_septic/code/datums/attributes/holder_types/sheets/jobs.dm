...
/datum/attribute_holder/sheet/job/inborn
    attribute_variance = list(
		STAT_STRENGTH = list(18, 25),
		STAT_ENDURANCE = list(10, 18),
		STAT_DEXTERITY = list(1, 3),
		STAT_INTELLIGENCE = list(-3, 1),
		SKILL_BRAWLING = list(1, 5),
		SKILL_WRESTLING = list(1, 4),
		SKILL_IMPACT_WEAPON = list(0, 5),
		SKILL_IMPACT_WEAPON_TWOHANDED = list(0, 4),
		SKILL_KNIFE = list(0, 4),
		SKILL_SMG = list(0, 1),
		SKILL_PISTOL = list(0, 1),
		SKILL_SHOTGUN = list(0, 1),
		SKILL_RIFLE = list(0, 1),
		SKILL_LONGSWORD = list(1, 5),
		SKILL_FORCESWORD = list(1, 5),
		SKILL_THROWING = list(1, 5),
		SKILL_FORENSICS = list(-2, 2),
		SKILL_ACROBATICS = list(5, 13),
	)
    raw_attribute_list = list(
		SKILL_BRAWLING = 2,
		SKILL_WRESTLING = 2,
